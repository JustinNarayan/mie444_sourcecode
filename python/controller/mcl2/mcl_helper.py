...
MOVEMENT_NOISE_LINEAR = 0.15      # inches (std dev of translational motion noise)
MOVEMENT_NOISE_ANGULAR = 0.1     # radians (std dev of rotational motion noise)
...
RESAMPLE_JITTER_THETA = 0.18     # radians, angular jitter after resampling
