...
#define DRIVETRAIN_AUTOMATED_MIN_SPEED (70) // 0 to 255
#define DRIVETRAIN_AUTOMATED_MAX_SLEW_UP (40) // delta speed to motor
#define DRIVETRAIN_AUTOMATED_MAX_SLEW_DOWN (-40) // delta speed to motor
#define DRIVETRAIN_AUTOMATED_DEADBAND (6)
#define DRIVETRAIN_MINIMUM_TIME_BETWEEN_CONTROL_ADJUSTEMENTS (15) // millis
...
#else
# define DRIVETRAIN_BACKWARDS_ADDED_GAIN (5)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_1 (100)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTOR_1 (0.03)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_1 (20)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_2 (80)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTOR_2 (0.02)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_2 (55)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_3 (155)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTOR_3 (0.05)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_3 (32)

# define DRIVETRAIN_MAXIMUM_PROPORTIONAL_MOTORS (40)
# define DRIVETRAIN_MAXIMUM_INTEGRAL_MOTORS (200)
# define DRIVETRAIN_MAXIMUM_DERIVATIVE_MOTORS (30)
