...
#define ENCODER_1_TUNING_GAIN ((float64_t)0.517)
#define ENCODER_2_TUNING_GAIN ((float64_t)0.519)
#define ENCODER_3_TUNING_GAIN ((float64_t)1.107)
...
#define DRIVETRAIN_TRANSLATE_SPEED (100) // 0 to 255
