...
#define DRIVETRAIN_AUTOMATED_COMMAND_MAX_TIME (2000UL) // millis

#define DRIVETRAIN_AUTOMATED_MAX_SPEED (150) // 0 to 255
#define DRIVETRAIN_AUTOMATED_MIN_SPEED (50) // 0 to 255
#define DRIVETRAIN_AUTOMATED_MAX_SLEW_UP (35) // delta speed to motor
#define DRIVETRAIN_AUTOMATED_MAX_SLEW_DOWN (-35) // delta speed to motor
...
#else
# define DRIVETRAIN_INITIAL_GAIN_MOTOR_1 (1.5)
# define DRIVETRAIN_INITIAL_GAIN_MOTOR_2 (1.0)
# define DRIVETRAIN_INITIAL_GAIN_MOTOR_3 (2.7)
# define DRIVETRAIN_BACKWARDS_ADDED_GAIN (1.5)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTORS (20)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTORS (30)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTORS (30)

# define DRIVETRAIN_MAXIMUM_INTEGRAL_MOTORS (10)
# define DRIVETRAIN_MAXIMUM_DERIVATIVE_MOTORS (25)
