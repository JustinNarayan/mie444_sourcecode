...
#define DRIVETRAIN_TRANSLATE_SPEED (140) // 0 to 255
#define DRIVETRAIN_TRANSLATE_SPEED_BACKWARD (145) // 0 to 255
#define DRIVETRAIN_ROTATE_SPEED (90) // 0 to 255
#define DRIVETRAIN_BRAKE_SPEED (180) // 0 to 255, holding torque
#define DRIVETRAIN_BRAKE_TIME_BEFORE_HALT_VOLUNTARY (100UL) // millis 

#define MOTOR_BROWNOUT_DIRECTION_TIMEOUT_US (1000) // micros
#define MOTOR_1_EMPIRICAL_GAIN(s) ((1.40f * s))
#define MOTOR_2_EMPIRICAL_GAIN(s) ((1.06f * s))
#define MOTOR_3_EMPIRICAL_GAIN(s) ((1.60f * s))
...
#define DRIVETRAIN_AUTOMATED_COMMAND_MAX_TIME (2800UL) // millis

#define DRIVETRAIN_AUTOMATED_MAX_SPEED (210) // 0 to 255
#define DRIVETRAIN_AUTOMATED_MIN_SPEED (140) // 0 to 255
#define DRIVETRAIN_AUTOMATED_MAX_SLEW_UP (60) // delta speed to motor
#define DRIVETRAIN_AUTOMATED_MAX_SLEW_DOWN (-60) // delta speed to motor
#define DRIVETRAIN_AUTOMATED_DEADBAND (15)
...
#else
# define DRIVETRAIN_BACKWARDS_ADDED_GAIN_MOTOR_1 (1.3)
# define DRIVETRAIN_BACKWARDS_ADDED_GAIN_MOTOR_2 (1.7)
# define DRIVETRAIN_BACKWARDS_ADDED_GAIN_MOTOR_3 (1.9)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_1 (75)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTOR_1 (23)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_1 (200)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_2 (33)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTOR_2 (10)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_2 (170)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_3 (68)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTOR_3 (17)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_3 (145)

# define DRIVETRAIN_MAXIMUM_PROPORTIONAL_MOTORS (3.75)
# define DRIVETRAIN_MAXIMUM_INTEGRAL_MOTORS (6)
# define DRIVETRAIN_MAXIMUM_DERIVATIVE_MOTORS (0.05)
# define DRIVETRAIN_ALLOWED_OVERSHOOT (0.7)
#endif
 ...
 */
#define LIDAR_MOTOR_SPIN_SPEED (240) // 0 - 255
...
#define LIDAR_SWEEP_STARTUP_MS (800UL) // millis
#define LIDAR_SWEEP_TIMEOUT_MS (1500UL) // millis
...
#define ULTRASONIC_SWEEP_MAX_TIME_MS (20000) // millis
#define ULTRASONIC_SWEEP_MINIMUM_ENCODER_ANGLE (2*PI * 0.8) // inches
...
#define GRIPPER_ARM_RETRACTED_POS (90)
#define GRIPPER_ARM_READY_POS (90)
#define GRIPPER_ARM_EXTENDED_POS (170)
#define GRIPPER_WRIST_OPENED_POS (135)
#define GRIPPER_WRIST_REST_POS (135)
#define GRIPPER_WRIST_CLOSED_POS (170)
#define SERVO_STEP_INCREMENT (2) // 0 to 255
#define SERVO_STEP_DELAY (20) // millis