...
#define DRIVETRAIN_TRANSLATE_SPEED (130) // 0 to 255
...
#define DRIVETRAIN_AUTOMATED_MAX_SPEED (190) // 0 to 255
#define DRIVETRAIN_AUTOMATED_MIN_SPEED (130) // 0 to 255
...
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_1 (220)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_2 (36)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTOR_2 (10)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_2 (120)

# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_3 (68)
# define DRIVETRAIN_AUTOMATED_GAIN_KI_MOTOR_3 (17)
# define DRIVETRAIN_AUTOMATED_GAIN_KD_MOTOR_3 (144)

# define DRIVETRAIN_MAXIMUM_PROPORTIONAL_MOTORS (3.5)
# define DRIVETRAIN_MAXIMUM_INTEGRAL_MOTORS (6)
# define DRIVETRAIN_MAXIMUM_DERIVATIVE_MOTORS (0.05)
# define DRIVETRAIN_ALLOWED_OVERSHOOT (1)
#endif
