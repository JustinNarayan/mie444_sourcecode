...
#define DRIVETRAIN_AUTOMATED_MAX_SLEW_UP (20) // delta speed to motor
#define DRIVETRAIN_AUTOMATED_MAX_SLEW_DOWN (-20) // delta speed to motor
#define DRIVETRAIN_AUTOMATED_DEADBAND (10)
#define DRIVETRAIN_MINIMUM_TIME_BETWEEN_CONTROL_ADJUSTEMENTS (5) // millis
#define DRIVETRAIN_AUTOMATED_POST_COMMAND_DISPLACEMENT_WAIT (50) // millis

#define DRIVETRAIN_AUTOMATED_GAIN_KP_DX (150)
#define DRIVETRAIN_AUTOMATED_GAIN_KI_DX (50)
#define DRIVETRAIN_AUTOMATED_GAIN_KD_DX (0)

#define DRIVETRAIN_AUTOMATED_GAIN_KP_DY (150)
#define DRIVETRAIN_AUTOMATED_GAIN_KI_DY (50)
#define DRIVETRAIN_AUTOMATED_GAIN_KD_DY (0)

#define DRIVETRAIN_AUTOMATED_GAIN_KP_DTHETA (50)
#define DRIVETRAIN_AUTOMATED_GAIN_KI_DTHETA (30)
#define DRIVETRAIN_AUTOMATED_GAIN_KD_DTHETA (0)

#define DRIVETRAIN_MAXIMUM_INTEGRAL (20)
#define DRIVETRAIN_MAXIMUM_DERIVATIVE (2)
