...
#define DRIVETRAIN_AUTOMATED_MIN_SPEED (120) // 0 to 255
...
#else
# define DRIVETRAIN_BACKWARDS_ADDED_GAIN_MOTOR_1 (1.2)
# define DRIVETRAIN_BACKWARDS_ADDED_GAIN_MOTOR_2 (1.6)
# define DRIVETRAIN_BACKWARDS_ADDED_GAIN_MOTOR_3 (1.8)
...
# define DRIVETRAIN_AUTOMATED_GAIN_KP_MOTOR_3 (72)
